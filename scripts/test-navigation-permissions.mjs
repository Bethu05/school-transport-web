...
const operationalRules = [
  ...
  [
    "label: 'Drivers'",
    'FRONTEND_PERMISSIONS.DRIVERS_READ',
  ],
  [
    "label: 'Students'",
...
for (
  ...
  assert(
    ...
    `${label} uses backend read permission`,
  );
  ...
  assert(
    ...
    `${label} no longer hard-codes roles`,
  );
}
...
console.log('');
console.log(
  'Navigation permissions checkpoint PASSED',
);
