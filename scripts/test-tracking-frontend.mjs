...
console.log();
console.log(
  'Live Tracking frontend checkpoint',
);
...
check(
  ...
  'Tracking page connected to router',
);

console.log();
console.log(
  'Live Tracking frontend checkpoint PASSED',
);
