...
const map =
  read(
    'src/tracking/LiveTrackingMap.tsx',
  );
...
const css =
  read(
    'src/tracking/live-tracking-map.css',
  );

console.log();
console.log(
  'Tracking map frontend checkpoint',
);
...
check(
  ...
  'OpenStreetMap tile layer wired',
);
...
check(
  ...
  'map automatically fits multiple vehicles',
);
...
check(
  ...
  'single vehicle receives focused map view',
);
...
check(
  ...
  'GPS accuracy overlay supported',
);
...
console.log();
console.log(
  'Tracking map frontend checkpoint PASSED',
);
