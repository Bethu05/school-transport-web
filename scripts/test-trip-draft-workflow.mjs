...
console.log();
console.log(
    'Trip draft workflow checkpoint',
);
console.log(
    '------------------------------',
);
...
check(
    ...
    'trip updates accept routeId',
);

check(
    page.includes(
        'class DraftSchedulingError',
    ),
...
check(
    !attentionRule.includes(
        "'draft'",
    ),
    'draft alone is not Action required',
);
...
console.log();
console.log(
    'Trip draft workflow checkpoint PASSED',
);
